      ...
      <div className="hospitalbg" style={{ backgroundColor: "#F4F4F4" }}>
        ...
        <div className="container">
          <div className="displayGridReviewDr">
            <div
              style={{ border: "none", height: "2000px", width: "325px" }}
              className="menuNav"
            >
              <Collapse
            ...
            <div className="menuRight">
              ...
              <div>
                ...
                >
                  <p style={{ marginRight: "auto", paddingLeft: "30px" }}>
                    <span style={{ color: "#5282FF" }}>
                      Получите доступ к скидкам на услуги Войти в{" "}
                    </span>
                    <br /> (только для зарегистрированных пользователей)
                  </p>
                  <Button
                    style={{
                      color: "white",
